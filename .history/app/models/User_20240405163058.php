...
class User extends Model {
   ...
   public function getUsers($filter=[]) {
      ...
      $listUsers = $listUsers->count();
      
      echo '<pre>';
      print_r($this->ad->getRaw("SELECT u.id, u.fullname, u.email, g.name as nameGroup, u.status, u.created_at FROM users as u INNER JOIN groups as g ON g.id = u.group_id WHERE status = '1' AND group_id = '1' AND u.fullname like '%tâm%'"));
      echo '</pre>';
