            ...
            <div class="row">
               <div class="col-3">
                  <select name="status" id="" class="form-control">
                     ...
                     <option value="active" {{$request->getFields()['status'] == '1' ? 'checked' : false}}>Kích hoạt</option>
                     <option value="inactive" {{$request->getFields()['status'] == '0' ? 'checked' : false}}>Chưa kích hoạt</option>
                  </select>
               </div>
               <div class="col-3">
