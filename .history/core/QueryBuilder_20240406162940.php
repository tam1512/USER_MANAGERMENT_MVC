...
trait QueryBuilder {
   ...
   private function getPaginateView($limit, $page) {
      ...
      $html = '<nav aria-label="Page navigation" class="d-flex justify-content-end"><ul class="pagination"><li class="page-item"><a class="page-link" href="'._WEB_HOST_ROOT.'/'.'">Trước</a></li>';
