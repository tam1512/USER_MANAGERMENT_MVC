...
trait QueryBuilder {
   ...
   private function getPaginateView($limit, $page) {
      ...
      if($page <= 1 && $page > $count) {
         ...
         $queryStr = preg_replace('/page\s*=\s*'.$page.'/', 'page='.($page-1), $queryStr);
      }
      ...
      $html = '<nav class="d-flex justify-content-end '.$isDisablePrev ? 'disabled' : false.'"><ul class="pagination"><li class="page-item"><a class="page-link" href="'._WEB_HOST_ROOT.$uri.'">Trước</a></li>';
         
      for($i = 1; $i < $numberPage; $i++) {
         $html .= '<li class="page-item"><a class="page-link" href="'.$this->getLinkPage($page, $i).'">1</a></li>';
      }

      $html .= '<li class="page-item"><a class="page-link" href="#">Sau</a></li></ul> </nav>'
