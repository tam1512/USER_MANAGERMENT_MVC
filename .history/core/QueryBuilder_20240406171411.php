...
trait QueryBuilder {
   ...
   private function getPaginateView($limit, $page) {
      ...
      $html = '<nav class="d-flex justify-content-end"><ul class="pagination"><li class="page-item'.($isDisablePrev ? ' disabled' : false).'"><a class="page-link" href="'._WEB_HOST_ROOT.$uriPrev.'">Trước</a></li>';
