...
trait QueryBuilder {
   ...
   public function paginate($limit, $limitPagination) {
      $request = new Request();
      ...
      if(filter_var($page, FILTER_VALIDATE_INT)) {
         ...
         $paginateView = $this->getPaginateView($limit, $page, $limitPagination);
         if(empty($data)) {
   ...
   private function getPaginateView($limit, $page, $limitPagination) {
      $pathInfo = trim($_SERVER['PATH_INFO'], '/');
      $queryStr =  $_SERVER['QUERY_STRING'];
