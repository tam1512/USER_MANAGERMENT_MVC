...
trait QueryBuilder {
   ...
   public function paginate($limit, $limitPagination, $isQuery = true) {
      ...
      if(filter_var($page, FILTER_VALIDATE_INT)) {
         ...
         if(empty($data) && preg_match('/page/', $linkPage)) {
   ...
   private function getPaginateView($limit, $page, $limitPagination, $isQuery) {
      ...
      $html = '<nav class="d-flex justify-content-end"><ul class="pagination pagination-sm"><li class="page-item'.($isDisablePrev ? ' disabled' : false).'"><a class="page-link" href="'.$linkPrev.'">Trước</a></li>';
