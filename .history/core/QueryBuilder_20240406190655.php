...
trait QueryBuilder {
   ...
   private function getPaginateView($limit, $page, $limitPagination, $isQuery) {
      ...
      $html = '<nav class="d-flex justify-content-end'.($numberPage <=1 ? 'd-none': false).'"><ul class="pagination pagination-sm"><li class="page-item'.($isDisablePrev ? ' disabled' : false).'"><a class="page-link" href="'.$linkPrev.'">Trước</a></li>';
